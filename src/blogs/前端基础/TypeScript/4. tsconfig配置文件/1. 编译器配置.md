...
位于 `compilerOptions` 对象内的选项，控制 TypeScript 编译的详细行为。完整的编译器选项文档请参考 [编译选项配置](./编译选项配置.md)。
...
### 3.2 编译器选项概览
编译器选项位于 `compilerOptions` 对象内，控制 TypeScript 编译的详细行为。完整的编译器选项文档请参考 [编译选项配置](./编译选项配置.md)。
...
## 附录
- **TypeScript 版本兼容性矩阵**：各选项的最低版本要求
- **配置选项完整索引**：所有根级选项和常用编译器选项速查
- **官方文档与资源链接**：
